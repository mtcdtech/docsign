...
- Completed Form Designer & Public Form Filler Enhancements (v0.12.0 - v0.12.6):
  - Database Schema: Added `emailParent`, `isDraft`, `emailedParent` columns and applied schema push.
  - SMTP: Fixed transporter TLS configuration, removing SSLv3 to support Office 365, and set default fallback `mailFrom` to match the SMTP authenticated user email to eliminate Microsoft Office 365 SendAsDenied exception errors.
...
## What is In Progress
- Final verification of v0.12.6 in production environment.
